...
@interface LZHAddCommentViewController ()
...
@implementation LZHAddCommentViewController
...
- (void) sendPushed{
    ...
    NSString * strUrl = [NSString stringWithFormat:@"%@/commentWeibo?userID=%@&time=%@&check=%@&weiboID=%d&commentDetail=%@", httpAddress, localUserID, currTime, [self getCheckCodeWithRequest:@"commentWeibo" andTime:currTime], self.weiboID, self.weiboField.text];
