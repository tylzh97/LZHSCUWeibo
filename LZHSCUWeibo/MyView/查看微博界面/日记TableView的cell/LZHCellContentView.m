...
@implementation LZHCellContentView
...
- (UILabel *)labelDay {
    if (!_labelDay) {
        ...
        _labelDay.textColor = LZHDiaryThemeBlueColor;
    }
    return _labelDay;
}
...
- (UILabel *)labelWeek {
    if (!_labelWeek) {
        ...
        _labelWeek.textColor = LZHDiaryThemeBlueColor;
    }
    return _labelWeek;
}
...
- (UILabel *)labelTime {
    if (!_labelTime) {
        ...
        _labelTime.textColor = LZHDiaryThemeBlueColor;
    }
    return _labelTime;
}
...
- (UILabel *)labelTitle {
    if (!_labelTitle) {
        ...
        _labelTitle.textColor = LZHDiaryThemeBlueColor;
    }
    return _labelTitle;
}
...
- (UILabel *)labelDetail {
    if (!_labelDetail) {
        ...
        _labelDetail.textColor = LZHDiaryThemeBlueColor;
    }
    return _labelDetail;
}
